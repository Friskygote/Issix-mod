...
- Some branches of choices and situations (some content requires second playthrough to experience)
...
- Combat, Fertility training for the player, countless minigames, some QoL improvements gated behind harem (for example removal of all empty comdoms from the inventory)
...
This mod introduces a lot of beginnings for, stubs of content without any endings. This is simply 

In tags: M/player, M/M (implied), petplay, slave, corruption (of PC), watersports, parasite

# Dependencies
There is a soft dependency on FoxLib 0.6.0+ - it allows you to choose player's body coverage seen in dialogues (fur, skin, scales etc.) inside mod options in the main menu, as well as allow for display of extended character set that allows to display runic characters that exist in two scenes. Thank you to Fox2Code for development of that one.

# Goals
## Mod's audience
Mod is directed pretty much exclusively at players who are submissive. In game there are already a bunch of ways the player can effectively submit to other creatures - recentlishly added hypnokink is a great example of that, Tavi's questline also has a route/revolves around player submitting to Tavi as their pet. Those things are wonderful and I love them, but in-game slave system is definitely directed at dominant players. This mod tries to address that by adding a character that can enslave **the player**. It features degradation, pet-play content, corruption, watersports (for those who switch it on), branding. In addition - worth noting that the entire harem of pets is male – this is not only because the writer for the mod is a man, but also because it's filling another niche in BDCC where the most major characters in the game are female and it doesn't seem this situation will change any time soon.

What you **shouldn't expect** from the mod at the moment is for it to be heavy on non-con or roughness. While the "non-con non-con" (instead of current voluntary non-con) is one of the ideas I have, it is planned to be implemented at later time if I have enough motivation. In fact, current content for many could even be seen as not slavery related enough with it being so easy on player, I'm open to feedback.
...
# Contributing
The main repository for the project exists on https://git.frisk.space/Frisk/Issix-mod now while GitHub is a mirror, regardless, contributions are welcome on GitHub (and they will be merged into main project on my website). Self-hosting the mod is mainly done to protect the mod from potential future purge of adult content on large platform like GitHub and to decrease dependence on large platforms.

Certain interaction in BDCC community shook me up a little and I've decided to add a politically motivated requirement for contributing to the mod.    
...
You are however free to take the code from this project (fork it) and develop it separately, I can't forbid you from doing that.

If you are not such a person and you have a good idea, the issue tracker is there, I welcome pull requests, if you are unsure whether what you like would fit the mod feel free to join a discussion, I don't bite and no kink grosses me out really *wink wink*! There are a lot of little threads that start in a mod that could be very simply expanded with some writing, there is no shame in adding something of your own and asking me to merge it.
...
- I want the mod to be a little statement and action behind my words of supporting sex-positivity by contributing something sexual and being public about it (like on my website, also, this is not to say that the mod is only for myself, even though in part it is)
